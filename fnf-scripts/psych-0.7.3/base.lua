...
function setText(tag, text) setProperty(tag..'.text', text) end -- condensed form of setProperty("bumfuck.text", "bumfuck string")
...
function isEmpty(s) return s == nil or s == '' end -- checks if string is empty
function clamp(val, low, high) if val < low then return low elseif val > high then return high else return val end end
function toggle(val) if val == true then return false else return true end end -- wtf is this :sob:
function ternary(a,b,c) if a then return b else return c end end -- equivalent of (cond ? iftrue : iffalse)
